...
def _admin_theme_to_vars(t) -> Dict[str, Any]:
    ...
    return {
        ...
        "--primary":       getattr(t, "accent_color",          None) or getattr(t, "link_color", None) or "#2563eb",
        "--surface":       getattr(t, "module_background_color", None) or "#f3f4f6",
        "--muted":         getattr(t, "breadcrumbs_link_color", None) or "#6b7280",
        # extras comuns:
        "--header-bg":     getattr(t, "header_background_color", None) or getattr(t, "header_color", None) or None,
