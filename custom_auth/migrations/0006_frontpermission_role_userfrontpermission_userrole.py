    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'permission', 'loja'), name='uniq_user_front_perm_per_loja')],
            },
        ),
        migrations.CreateModel(
            name='UserRole',
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'role', 'loja'), name='uniq_user_role_per_loja')],
            },
        ),
    ]
